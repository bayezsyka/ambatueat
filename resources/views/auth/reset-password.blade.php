        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8">
            <div class="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
                <div class="bg-[#d8ba89] px-8 py-6">
                    <h2 class="text-2xl font-medium text-gray-800">New Password</h2>
                    <p class="text-gray-700">Create your new password</p>
                </div>
                ...
                <div class="p-8">
                    <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                        ...
                        <div class="space-y-1">
                            ...
                            <input id="password_confirmation" class="w-full px-4 py-3 border-b border-gray-300 focus:border-[#d8ba89] focus:outline-none transition-colors"
